...
def create_ltx_video_pipeline(
    ...
    print(f"DEBUG: Starting pipeline creation with ckpt_path: {ckpt_path}")
    ckpt_path = Path(ckpt_path)
    print(f"DEBUG: Checking if checkpoint exists at: {ckpt_path}")
    assert os.path.exists(
        ckpt_path
    ), f"Ckpt path provided (--ckpt_path) {ckpt_path} does not exist"

    print("DEBUG: Loading checkpoint metadata...")
    ...
    print("DEBUG: Creating VAE...")
    vae = CausalVideoAutoencoder.from_pretrained(ckpt_path)
    print("DEBUG: VAE created successfully")
    
    print("DEBUG: Creating transformer...")
    transformer = create_transformer(ckpt_path, precision)
    print("DEBUG: Transformer created successfully")
    ...
    print("DEBUG: Scheduler created successfully")

    print("DEBUG: Creating text encoder...")
    text_encoder = T5EncoderModel.from_pretrained(
        text_encoder_model_name_or_path, subfolder="text_encoder"
    )
    print("DEBUG: Text encoder created successfully")
    
    print("DEBUG: Creating patchifier...")
    patchifier = SymmetricPatchifier(patch_size=1)
    print("DEBUG: Patchifier created successfully")
    
    print("DEBUG: Creating tokenizer...")
    tokenizer = T5Tokenizer.from_pretrained(
        text_encoder_model_name_or_path, subfolder="tokenizer"
    )
    print("DEBUG: Tokenizer created successfully")

    print("DEBUG: Moving models to device...")
    transformer = transformer.to(device)
    vae = vae.to(device)
    text_encoder = text_encoder.to(device)
    print("DEBUG: Models moved to device successfully")

    if enhance_prompt:
        print("DEBUG: Creating prompt enhancer models...")
        ...
        print("DEBUG: Prompt enhancer models created successfully")
    else:
        print("DEBUG: Skipping prompt enhancer models (enhance_prompt=False)")
...
def infer(config: InferenceConfig):
    ...
    print("DEBUG: About to get device...")
    device = get_device()
    ...
    print("DEBUG: About to load pipeline configuration...")
    ...
    print("DEBUG: About to create LTX video pipeline...")
    ...
    print("DEBUG: LTX video pipeline created successfully!")
